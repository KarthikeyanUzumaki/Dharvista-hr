          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="opacity-0 animate-fade-in" style={{ animationDelay: "250ms" }}>
              ...
              <div className="space-y-6">
                ...
                {/* Phone Card */}
                <div className="card-corporate flex items-start gap-4 opacity-0 animate-slide-up" style={{ animationDelay: "350ms" }}>
                ...
                {/* Email Card */}
                <div className="card-corporate flex items-start gap-4 opacity-0 animate-slide-up" style={{ animationDelay: "425ms" }}>
                  <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center shrink-0">
              ...
              {/* Office Hours */}
              <div className="mt-8 p-6 bg-secondary rounded-lg opacity-0 animate-fade-in" style={{ animationDelay: "600ms" }}>
              ...
              <div className="mt-8 rounded-xl overflow-hidden shadow-sm border opacity-0 animate-fade-in h-[300px]" style={{ animationDelay: "650ms" }}>
                  <iframe 
                    src={mapLink}
                    width="100%" 
                    height="100%" 
